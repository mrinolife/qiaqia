...
window.YAHA_FOODS = [
  ...
  { id:"tanghulu", emoji:"🍢", name:"Candied Hawthorn", hanzi:"糖葫芦", pinyin:"tánghúlu", en:"Candied hawthorn skewer",
    order:{ hanzi:"我要一串糖葫芦。", pinyin:"Wǒ yào yí chuàn tánghúlu.", en:"I want one skewer of candied hawthorn." },
    tip:"A shiny candy-glazed fruit skewer — crack the hard shell first, then bite into the tart fruit." },
  { id:"rouyuan", emoji:"🥮", name:"Taiwanese Meatball", hanzi:"肉圆", pinyin:"ròuyuán", en:"Taiwanese savory rice-flour dumpling",
    order:{ hanzi:"我要一份肉圆。", pinyin:"Wǒ yào yí fèn ròuyuán.", en:"I want one order of rouyuan." },
    tip:"A chewy, jelly-like wrapper hiding pork and bamboo shoots inside — Changhua's most famous dish." },
  { id:"migao", emoji:"🍚", name:"Rice Pudding", hanzi:"米糕", pinyin:"mǐgāo", en:"Taiwanese savory rice pudding",
    order:{ hanzi:"我要一碗米糕。", pinyin:"Wǒ yào yì wǎn mǐgāo.", en:"I want one bowl of rice pudding." },
    tip:"Sticky rice topped with braised pork and a pickled cucumber slice — a Tainan breakfast classic." },
  { id:"moci", emoji:"🍡", name:"Mochi", hanzi:"麻糬", pinyin:"máchí", en:"Chewy rice cake",
    order:{ hanzi:"我要一份麻糬。", pinyin:"Wǒ yào yí fèn máchí.", en:"I want one order of mochi." },
    tip:"Soft and chewy, often rolled in peanut powder or sesame — Hualien is famous for it." },
  { id:"taiyangbing", emoji:"🥮", name:"Sun Cake", hanzi:"太阳饼", pinyin:"tàiyángbǐng", en:"Flaky maltose pastry",
    order:{ hanzi:"我要一盒太阳饼。", pinyin:"Wǒ yào yì hé tàiyángbǐng.", en:"I want one box of sun cakes." },
    tip:"A flaky, sweet pastry from Taichung — a top souvenir box alongside pineapple cake." },
  { id:"ganzhezhi", emoji:"🥤", name:"Sugarcane Juice", hanzi:"甘蔗汁", pinyin:"gānzhèzhī", en:"Fresh-pressed sugarcane juice",
    order:{ hanzi:"我要一杯甘蔗汁。", pinyin:"Wǒ yào yì bēi gānzhèzhī.", en:"I want one sugarcane juice." },
    tip:"Pressed fresh from the stalk right at the stand — naturally sweet, no sugar added." },
  { id:"shengjianbao", emoji:"🥟", name:"Pan-Fried Buns", hanzi:"生煎包", pinyin:"shēngjiānbāo", en:"Pan-fried soup buns",
    order:{ hanzi:"我要五个生煎包。", pinyin:"Wǒ yào wǔ gè shēngjiānbāo.", en:"I want five pan-fried buns." },
    tip:"Crispy fried bottom, soft steamed top, hot soup inside — let them cool a second before biting." },
  { id:"luwei", emoji:"🍢", name:"Braised Snacks", hanzi:"卤味", pinyin:"lǔwèi", en:"Soy-braised snack platter",
    order:{ hanzi:"我要一份卤味, 不辣。", pinyin:"Wǒ yào yí fèn lǔwèi, bú là.", en:"I want one braised snack plate, not spicy." },
    tip:"Pick your own items from a tray — tofu, egg, and vegetables all soaked in a savory soy broth." },
  { id:"agei", emoji:"🥘", name:"A-Gei", hanzi:"阿给", pinyin:"āgěi", en:"Tamsui tofu pocket",
    order:{ hanzi:"我要一份阿给。", pinyin:"Wǒ yào yí fèn āgěi.", en:"I want one order of a-gei." },
    tip:"A fried tofu pouch stuffed with glass noodles, topped with fish paste — a Tamsui specialty." },
  { id:"xiancao", emoji:"🍮", name:"Grass Jelly Dessert", hanzi:"烧仙草", pinyin:"shāoxiāncǎo", en:"Warm grass jelly dessert soup",
    order:{ hanzi:"我要一碗烧仙草。", pinyin:"Wǒ yào yì wǎn shāoxiāncǎo.", en:"I want one bowl of grass jelly dessert." },
    tip:"Served warm with toppings like taro balls and peanuts — cozy on a cool night market evening." },
  { id:"yuyuan", emoji:"🟣", name:"Taro Balls", hanzi:"芋圆", pinyin:"yùyuán", en:"Chewy taro and sweet potato balls",
    order:{ hanzi:"我要一碗芋圆。", pinyin:"Wǒ yào yì wǎn yùyuán.", en:"I want one bowl of taro balls." },
    tip:"Chewy purple and orange balls served over shaved ice or in hot syrup — Jiufen's signature treat." },
  { id:"honeycake", emoji:"🍰", name:"Honey Castella Cake", hanzi:"蜂蜜蛋糕", pinyin:"fēngmì dàngāo", en:"Honey sponge cake",
    order:{ hanzi:"我要一块蜂蜜蛋糕。", pinyin:"Wǒ yào yí kuài fēngmì dàngāo.", en:"I want one piece of honey cake." },
    tip:"Super light and jiggly — night market stalls often cut it fresh from a giant warm loaf." }
];
